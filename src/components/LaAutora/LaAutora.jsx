  ...
  return (
    <div className={styles.LaAutora}>
      <Container className="my-3">
        ...
        <p>
          Aparte de aprender tecnologías nuevas, me gusta aprender sobre temas
          más manuales como este de la
          {' '}
          <a
          ...
          goma, cuidado de plantas tropicales, y... básicamente lo que se me
          ponga por delante.
          {' '}
        </p>
